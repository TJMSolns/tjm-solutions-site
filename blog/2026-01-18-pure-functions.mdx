...
<head>
  ...
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"Pure Functions: Your First Step Toward Bug-Free Concurrency","description":"How pure functions — same inputs, same outputs, no side effects — eliminate entire categories of concurrency bugs and make pricing, eligibility, and promotion logic reliably testable at scale.","datePublished":"2026-01-18","author":{"@type":"Person","name":"Tony Moores","url":"https://www.tjm.solutions/tony"},"publisher":{"@type":"Organization","name":"TJM Solutions","url":"https://www.tjm.solutions"},"url":"https://www.tjm.solutions/articles/2026/01/18/pure-functions","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.tjm.solutions/articles/2026/01/18/pure-functions"}}`}</script>
</head>
