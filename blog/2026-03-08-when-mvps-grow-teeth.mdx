...
<head>
  ...
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"When MVPs Grow Teeth","description":"How pragmatic domain models accumulate impossible states over time, and why algebraic data types prevent them by design.","datePublished":"2026-03-08","author":{"@type":"Person","name":"Tony Moores","url":"https://www.tjm.solutions/about"},"publisher":{"@type":"Organization","name":"TJM Solutions","url":"https://www.tjm.solutions"},"url":"https://www.tjm.solutions/articles/2026/03/08/when-mvps-grow-teeth","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.tjm.solutions/articles/2026/03/08/when-mvps-grow-teeth"}}`}</script>
</head>
