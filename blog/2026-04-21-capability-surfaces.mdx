---
title: "Capability Surfaces: A Mediating Architecture for Agent-Native Commerce"
description: "How a mediating architectural pattern called capability surfaces reduces agent-merchant integration complexity from O(A×M) to O(A+M), enabling any compliant agent to transact with any compliant merchant without bespoke integration."
date: 2026-04-21
authors: [tony]
tags: [architecture, ai, digital-commerce, agentic-commerce]
image: /img/digital-transformation.jpg
---

<head>
  <link rel="canonical" href="https://www.tjm.solutions/articles/2026/04/21/capability-surfaces" />
  <meta property="og:type" content="article" />
  <meta property="article:published_time" content="2026-04-21T00:00:00Z" />
  <meta property="article:author" content="Tony Moores" />
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"Capability Surfaces: A Mediating Architecture for Agent-Native Commerce","description":"How a mediating architectural pattern called capability surfaces reduces agent-merchant integration complexity from O(A×M) to O(A+M), enabling any compliant agent to transact with any compliant merchant without bespoke integration.","datePublished":"2026-04-21","author":{"@type":"Person","name":"Tony Moores","url":"https://www.tjm.solutions/about"},"publisher":{"@type":"Organization","name":"TJM Solutions","url":"https://www.tjm.solutions"},"url":"https://www.tjm.solutions/articles/2026/04/21/capability-surfaces","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.tjm.solutions/articles/2026/04/21/capability-surfaces"}}`}</script>
</head>
...
1. We name and formalize the **capability surface** as a distinct architectural layer between merchant microservices and external agents.
2. We specify the required formal properties of a capability surface: determinism, schema completeness, versioned stability, discoverability, and explicit error contracts.
3. We demonstrate through scenario analysis how capability surfaces reduce the agent-merchant integration problem from O(A × M) to O(A + M).
4. We map MCP as a capability surface mechanism and UCP as a domain vocabulary layer, positioning them in a layered protocol stack.
5. We identify open research problems in capability contract governance, registry certification, and agent identity that remain unsolved.
...
Response: $2,400, 5-day delivery. Total: $35,600 + $2,400 = $38,000. Within budget.
