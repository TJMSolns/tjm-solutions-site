...
<head>
  ...
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"A Protocol Stack for Agent-Native Commerce: MCP, Domain Profiles, and Open Interoperability","description":"A layered protocol stack perspective on agentic-commerce interoperability: MCP as a general capability mechanism, commerce-domain profiles as shared vocabulary, and capability registries as discovery infrastructure.","datePublished":"2026-04-21","author":{"@type":"Person","name":"Tony Moores","url":"https://www.tjm.solutions/tony"},"publisher":{"@type":"Organization","name":"TJM Solutions","url":"https://www.tjm.solutions"},"url":"https://www.tjm.solutions/articles/2026/04/21/protocol-stack-agent-native-commerce","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.tjm.solutions/articles/2026/04/21/protocol-stack-agent-native-commerce"}}`}</script>
</head>
