...
<head>
  ...
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"When Good Enough is Not","description":"Why commerce systems that read fine to a human buyer routinely fail to give a purchasing agent a decision it can safely act on -- and how algebraic data types close that gap.","datePublished":"2026-04-28","author":{"@type":"Person","name":"Tony Moores","url":"https://www.tjm.solutions/tony"},"publisher":{"@type":"Organization","name":"TJM Solutions","url":"https://www.tjm.solutions"},"url":"https://www.tjm.solutions/articles/2026/04/28/when-good-enough-is-not","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.tjm.solutions/articles/2026/04/28/when-good-enough-is-not"}}`}</script>
</head>
