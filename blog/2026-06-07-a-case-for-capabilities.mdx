...
<head>
  ...
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"A Case for Capabilities","description":"Why agent-facing commerce platforms should model business capabilities as a typed algebra before mapping them onto any protocol -- MCP, UCP, or otherwise.","datePublished":"2026-06-07","author":{"@type":"Person","name":"Tony Moores","url":"https://www.tjm.solutions/tony"},"publisher":{"@type":"Organization","name":"TJM Solutions","url":"https://www.tjm.solutions"},"url":"https://www.tjm.solutions/articles/2026/06/07/a-case-for-capabilities","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.tjm.solutions/articles/2026/06/07/a-case-for-capabilities"}}`}</script>
</head>
