...
<head>
  ...
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"What Time Is It?","description":"Why treating Instant.now() as a plain value instead of an explicit input is a silent source of pricing and business-logic bugs in commerce systems.","datePublished":"2026-07-05","author":{"@type":"Person","name":"Tony Moores","url":"https://www.tjm.solutions/tony"},"publisher":{"@type":"Organization","name":"TJM Solutions","url":"https://www.tjm.solutions"},"url":"https://www.tjm.solutions/articles/2026/07/05/what-time-is-it","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.tjm.solutions/articles/2026/07/05/what-time-is-it"}}`}</script>
</head>
