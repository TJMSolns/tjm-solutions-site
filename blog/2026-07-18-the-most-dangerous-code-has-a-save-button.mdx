...
<head>
  ...
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BlogPosting","headline":"The Most Dangerous Code Has a Save Button","description":"Configuration is code with a weaker deployment process -- why tax tables, pricing rules, and admin-panel settings deserve types, validation at authoring time, and a deterministic evaluator.","datePublished":"2026-07-18","author":{"@type":"Person","name":"Tony Moores","url":"https://www.tjm.solutions/tony"},"publisher":{"@type":"Organization","name":"TJM Solutions","url":"https://www.tjm.solutions"},"url":"https://www.tjm.solutions/articles/2026/07/18/the-most-dangerous-code-has-a-save-button","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.tjm.solutions/articles/2026/07/18/the-most-dangerous-code-has-a-save-button"}}`}</script>
</head>
