...
export type Glyph = 'clock' | 'checkSquare' | 'users' | 'calendar';

// Phosphor Icons (MIT license, https://phosphoricons.com), fill style --
// the same system used for the CS/DT/EE category marks, applied to the
// rest of the offer page (duration, deliverables, credibility, CTA)
// rather than stopping at 3 bespoke marks.
